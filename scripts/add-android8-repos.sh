...
wget https://build.lolinet.com/file/overlay-reader/getoverlay_0.1.0_arm64.deb -P /root/overlay-reader/
wget https://build.lolinet.com/file/overlay-reader/liboverlay-reader_0.1.0_arm64.deb -P /root/overlay-reader/
wget https://build.lolinet.com/file/overlay-reader/liboverlay-reader-dev_0.1.0_arm64.deb -P /root/overlay-reader/
...
wget https://build.lolinet.com/file/repowerd/repowerd_2018.04+ubports_arm64.deb -P /root/repowerd/
wget https://build.lolinet.com/file/repowerd/repowerd-data_2018.04+ubports_all.deb -P /root/repowerd/
wget https://build.lolinet.com/file/repowerd/repowerd-tools_2018.04+ubports_arm64.deb -P /root/repowerd/
...
wget https://build.lolinet.com/file/qtubuntu-position/qtubuntu-position_0.1%2Bubports_arm64.deb -P /root/qtubuntu-position/
